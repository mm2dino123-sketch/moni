--// Moni's Hub - Full UI Package (Spacious Fixed)
...
-------------------------------
-- MAIN HUB + TABS (SPACIOUS)
-------------------------------

local HubFrame = Instance.new("Frame")
HubFrame.Name = "HubFrame"
HubFrame.Size = UDim2.new(0, 620, 0, 330) -- wider + taller
HubFrame.Position = UDim2.new(0.5, -310, 0.5, -165)
...
-- Tabs frame (left) – wider
local TabsFrame = Instance.new("Frame")
TabsFrame.Name = "TabsFrame"
TabsFrame.Size = UDim2.new(0, 140, 1, -70)
...
TabsLayout.Padding = UDim.new(0, 8) -- more spacing
TabsLayout.FillDirection = Enum.FillDirection.Vertical
TabsLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
TabsLayout.VerticalAlignment = Enum.VerticalAlignment.Top
TabsLayout.SortOrder = Enum.SortOrder.LayoutOrder

-- Content frame (right) – more room
...
local function createPage(tabName)
    ...
    Layout.Padding = UDim.new(0, 10) -- more vertical spacing
...
local function createSlider(parent, name, minValue, maxValue, defaultValue, callback)
    ...
    SliderFrame.Size = UDim2.new(0, 260, 0, 46)
...
_G.MONIS_HUB_CALLBACKS = Callbacks
...
PanelInfo.Size = UDim2.new(1, -10, 0, 40)
...
JobIdBox.Size = UDim2.new(0, 260, 0, 28)
...
WebhookBox.Size = UDim2.new(0, 260, 0, 28)

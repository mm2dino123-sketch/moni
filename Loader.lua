--// Moni's Hub - UI Suite (Full)
--// Tabs + Draggable MH Button + Booster UI Variants
--// UI ONLY — you wire your own gameplay logic behind callbacks
...
Info.Text = "Get the key from the Moni's Hub Discord."
...
KeyBox.BackgroundColor3 = Color3.fromRGB(18, 18, 25)
...
Submit.Position = UDim2.new(0, 10, 0, 130)
...
DiscordBtn.Position = UDim2.new(0.5, 5, 0, 130)
DiscordBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 40)
...
HubFrame.Size = UDim2.new(0, 460, 0, 270)
HubFrame.Position = UDim2.new(0.5, -230, 0.5, -135)
HubFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 12)
...
local function createToggle(parent, name, default, callback)
    ...
    Toggle.BackgroundColor3 = Color3.fromRGB(18, 18, 26)
    ...
    Indicator.BackgroundColor3 = state and Color3.fromRGB(0, 200, 100) or Color3.fromRGB(60, 60, 80)
...
createSectionLabel(MainPage, "Info")

local InfoLabel = Instance.new("TextLabel")
InfoLabel.Size = UDim2.new(1, 0, 0, 40)
InfoLabel.BackgroundTransparency = 1
InfoLabel.Text = "Moni's Hub UI loaded.\nTabs and toggles are ready."
...
createButton(MainPage, "Toggle Hub (also LeftCtrl & MH)", function()
    HubFrame.Visible = not HubFrame.Visible
end)

-------------------------------
-- STEALER TAB (UI SHELL)
-------------------------------

createSectionLabel(StealerPage, "Stealer UI")

createToggle(StealerPage, "Auto Steal (Hold E) UI", false, function(state)
    -- You can connect your own auto-steal logic here
    notify("Moni's Hub", "Stealer UI toggle: " .. (state and "ON" or "OFF"), 2)
end)

-------------------------------
-- BOOSTER TAB (ALL VARIANTS)
-------------------------------

createSectionLabel(BoosterPage, "Booster Toggle")
...
local setBoosterToggle = createToggle(BoosterPage, "Booster Mode", false, function(state)
    ...
    -- Hook your booster logic here if you choose
    notify("Moni's Hub", "Booster UI: " .. (state and "ON" or "OFF"), 2)
end)

createSectionLabel(BoosterPage, "Chilli-style Booster Panel")
...
PanelTitle.Text = "Booster Preset"
...
createSectionLabel(BoosterPage, "Sliders (Visual Only)")
